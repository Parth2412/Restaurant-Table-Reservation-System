...
public final class manager_002dlogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<form action=\"managerLoginController\" method=\"post\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"email\" class=\"user\" name=\"manager_email\" placeholder=\"Enter Your Email\" required=\"\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"password\" name=\"manager_password\" class=\"lock\" placeholder=\"Password\" required=\"\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<a class=\"\" href=\"manager-register.jsp\">\n");
